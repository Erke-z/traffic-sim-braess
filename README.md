...
The aim of the works is to find Braess Links in Almaty's road network. As a result of the research, parts of the Kozhamkulov Street and Utegen Batyr Street were defined as Braess Links and were removed in the modified network. You can see their image at .png files.
